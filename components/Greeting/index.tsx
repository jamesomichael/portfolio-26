...
const Greeting = () => {
	return (
		<div className="sm:my-36 flex justify-center items-center">
			<div className="max-w-screen-lg bg-slate-950 text-white p-8 grid grid-rows-[auto,1fr] gap-6 select-text">
				...
				<div className="font-urbanist flex flex-col gap-3 font-stretch-[110%] text-sm sm:text-base">
					...
					<p>
						With six years of industry experience, I specialise in
						web development and have worked with a range of
						languages, frameworks, and tools throughout my career.
					</p>
					<p>
						My background is primarily backend-focused, with
						particular emphasis on JavaScript (Node.js, TypeScript)
						and databases (MySQL, Firestore, MongoDB). Recently,
						I&apos;ve been delving deeper into the frontend world,
						gaining experience with technologies like React,
						Next.js, and Tailwind CSS. This portfolio is just one
						example of my work!
					</p>
					<p>
						I&apos;m now looking to embrace a new challenge &mdash;
						one which allows me to combine my strong backend skills
