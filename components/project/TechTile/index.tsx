...
const TechTile = ({
	...
	return (
		...
		>
			<div className="absolute inset-0 bg-linear-to-b from-transparent to-black/25 rounded-xl sm:rounded-2xl"></div>
			<div className="relative z-50 flex justify-center items-center">
				{icon}
			</div>
			<div className="relative z-50 h-11 px-2 pb-6 flex justify-center items-center">
