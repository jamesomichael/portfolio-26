...
const ProjectLink = ({
	...
	return (
		<Link
			...
			className={`group/project transition-colors duration-200 hover:bg-slate-800 flex justify-center items-center rounded-xl h-14 ${isActiveProject ? 'bg-slate-700 pointer-events-none' : ''}`}
		>
			<div
